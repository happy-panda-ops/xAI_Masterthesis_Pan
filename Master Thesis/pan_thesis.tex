...
% ----------------------------------------------------------------------------
\thesisTitle{AI-Assisted Estimation of Wood Knots in Historic Beams}
...
\input{Master Thesis/Parts/3_methodology}

\subsection{Segmentation of wooden beams}
\label{subsec:another}

\input{Master Thesis/Parts/3.1_segmentation}

\subsection{Detection of wood knots}
\label{subsec:yetanother}

\input{Master Thesis/Parts/3.2_detection}

\subsection{Estimation of wood knots}
\label{subsec:last}

\input{Master Thesis/Parts/3.3_estimation}
